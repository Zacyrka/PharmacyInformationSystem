...
<head>
    <meta charset="UTF-8">
    <title>Statistika apie išraštus vaistus</title>
    <link rel="stylesheet" href="../Stiliai/Statistika.css"> <!-- Link to the CSS file -->
</head>
<body>
    <h1>Statistika apie išraštus vaistus</h1>
    <a href="Statistika.php">Kita statistika</a> <!-- Link to another statistics page -->
    ...
    $query = "SELECT pavadinimas, vienetai FROM istorija GROUP BY vienetai DESC";
